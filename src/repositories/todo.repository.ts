...
> {
  ...
  constructor(
    @inject('datasources.chatDb') dataSource: ChatDbDataSource, @repository.getter('TodoListRepository') protected todoListRepositoryGetter: Getter<TodoListRepository>,
  ) {
